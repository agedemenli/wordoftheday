...
class SimpleTest(TestCase):
    # This one only tests the status code of the response.
    ...
    # because the word of the day will change everyday. You can run these tests by 
    # uncommenting them and manually add the words of the day that you test, in each language.
